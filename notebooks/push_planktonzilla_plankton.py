...
hf_dataset = load_from_disk("/lustre/fsn1/projects/rech/tec/uod68bo/data/planktonzilla_only_plankton2")
...
importer = PlanktonzillaDatasetImporter(
    ...
    hf_private=False,
    push_to_hub=True,
    hf_dataset_name="planktonzilla_only_plankton",
    ...
    source_url="https://huggingface.co/datasets/project-oceania/planktonzilla_only_plankton",
    license="cc-by-4.0",
    citation_bibtex="""@misc{planktonzilla_only_plankton,
        author       = {Inria Chile},
        ...
        version      = {1.0.0},
        doi          = {TBD},
        url          = {https://huggingface.co/datasets/project-oceania/planktonzilla_only_plankton},
    }""",
)
